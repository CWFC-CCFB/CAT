...
abstract class PythonCarbonToolCompatibleTree implements 	CATCompatibleTree, 
	...
	PythonCarbonToolCompatibleTree(Species species,
			StatusClass statusClass, 
			double number, 
			double biomassRoots,
			double biomassTrunk,
	...
	@Override
	public double getBasicWoodDensity() {return getSpecies(CarbonAccountingTool.CAT).getBasicWoodDensity(getSpeciesLocale());}
