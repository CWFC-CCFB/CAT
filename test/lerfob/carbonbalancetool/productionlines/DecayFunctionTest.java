...
public class DecayFunctionTest {
	...
	public void test03SensitivityAnalysisExponentialFunction() {
		...
		double oneMinusMeanRatio = Math.abs(1d - meanRatio);
		System.out.println("One minus mean ratio = " + oneMinusMeanRatio);
	...
	public void test04SensitivityAnalysisWeibullFunction() {
		...
		Assert.assertTrue("Testing mean", Math.abs(1d - meanRatio) < 0.03);
		System.out.println("Variance ratio = " + varianceRatio);
